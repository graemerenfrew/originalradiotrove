...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EpisodeBase.length'
        db.add_column('episodes', 'length',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # Changing field 'EpisodeBase.audioFileLocation'
        db.alter_column('episodes', 'audioFileLocation', self.gf('django.db.models.fields.FilePathField')(max_length=1000))

    def backwards(self, orm):
        # Deleting field 'EpisodeBase.length'
        db.delete_column('episodes', 'length')


        # Changing field 'EpisodeBase.audioFileLocation'
        db.alter_column('episodes', 'audioFileLocation', self.gf('django.db.models.fields.URLField')(max_length=2000))
    ...
    models = {
        ...
        u'creativework.episodebase': {
            ...
            'audioFileLocation': ('django.db.models.fields.FilePathField', [], {'default': "'/'", 'max_length': '1000'}),
