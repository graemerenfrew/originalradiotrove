...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EpisodeBase.title'
        db.add_column('episodes', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


        # Changing field 'EpisodeBase.audioFileLocation'
        db.alter_column('episodes', 'audioFileLocation', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):
        # Deleting field 'EpisodeBase.title'
        db.delete_column('episodes', 'title')
