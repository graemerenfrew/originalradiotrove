...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContentSource'
        db.create_table(u'creativework_contentsource', (
        ...
        db.send_create_signal(u'creativework', ['ContentSource'])


    def backwards(self, orm):
        # Deleting model 'ContentSource'
        db.delete_table(u'creativework_contentsource')
