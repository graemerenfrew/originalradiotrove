...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field partOfParentGenres on 'Genre'
        db.create_table('genre_partOfParentGenres', (
        ...
        db.create_unique('genre_partOfParentGenres', ['genre_id', 'parentgenre_id'])


    def backwards(self, orm):
        # Removing M2M table for field partOfParentGenres on 'Genre'
        db.delete_table('genre_partOfParentGenres')
