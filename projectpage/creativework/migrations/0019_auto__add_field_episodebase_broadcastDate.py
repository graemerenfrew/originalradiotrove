...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EpisodeBase.broadcastDate'
        db.add_column('episodes', 'broadcastDate',
                      self.gf('django.db.models.fields.DateField')(default='1970-01-01'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EpisodeBase.broadcastDate'
        db.delete_column('episodes', 'broadcastDate')
