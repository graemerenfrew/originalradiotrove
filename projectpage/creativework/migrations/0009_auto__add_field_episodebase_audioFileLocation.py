...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EpisodeBase.audioFileLocation'
        db.add_column('episodes', 'audioFileLocation',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=2000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EpisodeBase.audioFileLocation'
        db.delete_column('episodes', 'audioFileLocation')
