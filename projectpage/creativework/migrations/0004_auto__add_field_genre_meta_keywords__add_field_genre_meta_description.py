...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genre.meta_keywords'
        db.add_column('genre', 'meta_keywords',
                      self.gf('django.db.models.fields.CharField')(default='meta', max_length=255),
                      keep_default=False)

        # Adding field 'Genre.meta_description'
        db.add_column('genre', 'meta_description',
                      self.gf('django.db.models.fields.CharField')(default='meta', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Genre.meta_keywords'
        db.delete_column('genre', 'meta_keywords')

        # Deleting field 'Genre.meta_description'
        db.delete_column('genre', 'meta_description')
