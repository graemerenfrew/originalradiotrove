...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Season.audioFolder'
        db.add_column('seasons', 'audioFolder',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=2000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Season.audioFolder'
        db.delete_column('seasons', 'audioFolder')
    ...
    models = {
        ...
        u'creativework.season': {
            ...
            'audioFolder': ('django.db.models.fields.URLField', [], {'default': "''", 'max_length': '2000'}),
