...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Season.partOfSeries'
        db.add_column('seasons', 'partOfSeries',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=8, to=orm['creativework.Series']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Season.partOfSeries'
        db.delete_column('seasons', 'partOfSeries_id')
