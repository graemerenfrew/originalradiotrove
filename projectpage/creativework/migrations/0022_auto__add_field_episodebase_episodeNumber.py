...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EpisodeBase.episodeNumber'
        db.add_column('episodes', 'episodeNumber',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EpisodeBase.episodeNumber'
        db.delete_column('episodes', 'episodeNumber')
