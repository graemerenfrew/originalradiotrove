...
DJANGO_SERVER_STOP = posixpath.join('/home/grenfrew/webapps/radiostream', 'apache2', 'bin', 'stop')
DJANGO_SERVER_START = posixpath.join('/home/grenfrew/webapps/radiostream', 'apache2', 'bin', 'start')
